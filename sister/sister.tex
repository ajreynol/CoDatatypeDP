...
%
\begin{enumerate}
\item Unfold $\Varec{x}$:\enskip $\Val = \{\vthinspace  \ec{x} \mapsto \MU {\Varec{x}}.\; \const{C}( {\Varec{w}},\, {\Varec{y}} ) \vthinspace\}$
\item Unfold $\Varec{y}$:\enskip $\Val = \{\vthinspace  \!\begin{aligned}[t]
  & \ec{x} \mapsto \MU {\Varec{x}}.\; \const{C}( {\Varec{w}},\; \MU {\Varec{y}}.\; \const{C}( {\Varec{z}},\, {\Varec{x}} ) ),\; \\[-.5\jot]
  & \ec{y} \mapsto \MU {\Varec{y}}.\; \const{C}( {\Varec{z}},\, {\Varec{x}} ) \vthinspace\}\end{aligned}$
\item Unfold $\Varec{x}$:\enskip $\Val = \{\vthinspace \!\begin{aligned}[t]
  & \ec{x} \mapsto \MU {\Varec{x}}.\; \const{C}( {\Varec{w}},\; \MU {\Varec{y}}.\; \const{C}( {\Varec{z}},\, {\Varec{x}} ) ),\; \\[-.5\jot]
  & \ec{y} \mapsto \MU {\Varec{y}}.\; \const{C}( {\Varec{z}},\; \MU {\Varec{x}}.\; \const{C}( {\Varec{w}},\, {\Varec{y}} ) ) \vthinspace\}\end{aligned}$
\end{enumerate}
%
...
\begin{center}\begin{tabular}{@{\;}l@{\kern1.5em}c@{\kern.5em}c@{\kern1em}c@{\kern.5em}c@{\;}}
  & \multicolumn{2}{@{}c@{\kern1em}}{16 lemmas\;} & \multicolumn{2}{@{}c@{\;}}{256 lemmas} \\%[-0.5pt]
