...
to reason about these types. The procedure has been
...
finding, or constraint solving: given some constraints, they can often find a
variable assignment that satisfy them.
...
the non-well-founded dual of datatypes.
%
...
\shortcite{lochbihler-2014-jmm} both depend on codatatypes to capture infinite
processes.
