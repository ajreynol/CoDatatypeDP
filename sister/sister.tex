...
have emerged as one of the most powerful ways to prove theorems in first-order
logic. These solvers are also useful for constraint solving, or model finding:
...
This paper offers the following partial answer:\ freely generated algebraic
