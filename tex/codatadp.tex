...
We presented a decision procedure for datatypes and codatatypes and implemented
it in the SMT solver CVC4. Our main theoretical contribution has been the
extension of the procedure with codatatypes. Codatatypes are not very difficult
...
results on Isabelle benchmarks, including some rather
%mind-boggling
