...
and let $\tcEc$ be the set of subterms of $\Ec \mathrel\cup \{ C_i( s^1_i( t ), \ldots, s^{a_i}_i( t ) ) \mid t : \tau \in S \mathrel\cup S^\ast, C_i \in \Ctr^\tau \}$.
...
then by the induction hypothesis $\Ec \mathrel\cup t \teq C_i( s^1_i( t ), \ldots, s^{a_i}_i( t ) )$ is unsatisfiable
