...
Given $\Val$, the rules for cyclicity and bisimilar (shown in Figure~\ref{fig:ab-rules}) can be stated as follows.
...
We demonstrate an application of the rule for bisimilarity concretely with the following example.
