...
\rem{define $\sim$}
We assume these rules are applied to completion in the order in which they are written,
that is, \rn{Ind} is applied exhaustively before applying \rn{Base}.
