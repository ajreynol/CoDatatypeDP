...
Together with the rules \rn{Refl}, \rn{Sym}, \rn{Trans}, the rule \rn{Cong} computes the (upward) congruence closure,
...
We compute the \emph{completion} of $\Val$ for normal model $\M$, which we will write as $\Val^\ast$,
...
=======
By our construction of $\Val^\ast$ and since \rn{Unify$_1$} and \rn{Unify$_2$} do not apply to $\Fc$, 
>>>>>>> aea1c9e135f131de10fcb422608e8c62b2d63fbe
