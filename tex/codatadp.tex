...
uniqueness rule that identifies bisimilar values, also in the presence of cyclic
...
The uniqueness principle states that two values having the same (possibly
...
whose root node is $\Ec \cup t_1 \teq t_2$ obtained by applying one of the rules \rn{Refl}, \rn{Sym}, \rn{Trans}, \rn{Cong}, \rn{Inject}, \rn{Unique}, or \rn{Singleton}.
...
For \rn{Unique}, our construction of $\Val$ indicates that the value of $t_1$ and $t_2$ are equivalent in all models of $\Ec$.
...
%which by the induction hypothesis is $\alpha$-equivalent with $\Val^\ast \ec{u}$.
