...
\begin{report}When applied to terms, the symbol $=$ denotes syntactic equality.\end{report}
...
the datatype. This rules out non-well-founded specifications\begin{paper}.\end{paper}
\begin{report}%
such as
