...
Given a $\mu$-term $t$ of the form $\MU x.\; \const{C}( t_1, \ldots, t_n )$,
a subterm $u$ is a \emph{bisimilar subterm} of~$t$ if it is of the form
$\MU y.\; \const{C}( u_1, \ldots, u_n )$ and $\interp{t}{ t_k } \aequiv \interp{t}{ u_k }$ for $k \in \{1,\ldots,n\}$.
...
we know $\ec{x}$ contains a constructor $\const{C}( z_1, \ldots, z_n )$ and $\muvar( t_i ) = z_i$ for $i \in \{1,\ldots,n\}$.
Since $\Val \ec{x}$ is a minimal, it
contains a subterm of the form $\MU {\Varec{y}}.\; \const{C}( u_1, \ldots, u_n )$
where $\interp{\Val \ec{x}}{ t_i } \aequiv \interp{\Val \ec{x} }{ u_i }$ for $i \in \{1,\ldots,n\}$.
Due to our construction of $\Val$, $\ec{y}$ contains a constructor $\const{C}( w_1, \ldots, w_n )$ and $\muvar( u_i ) = w_i$ for $i \in \{1,\ldots,n\}$.
...
%where $\interp{\Val^\AST \ec{t}}{w_i} = \Val^\AST \ec{u_i}$ for $i \in \{1,\ldots,n\}$.
...
Thus $\interp{t_u}{u_\iPrime} \vsim \interp{\Val^\AST \ec{t}}{ w_i }$. % for each $i \in \{1,\ldots,n\}$.
