...
\label{sec:experimental-results}
  ...
  * how many problems
  * how many problems have some codatatypes, how many have datatypes (including
    XXX that have both)
  ...
  * wanted to evaluate both the impact of datatypes and codatatypes
  * datatypes are known to be very useful on SMT-LIB, e.g. blah
  * but we wanted to see how much they make a difference in Isabelle

  * ran all problems four times, to try all four combinations of datatypes and
    codatatypes enabled or disabled

  * lemmas/axioms often include basic properties of constructor and selectors,
    which are tautologies and ignored if (co)datatypes are enabled
  * allows a fair comparison: how much do (co)datatype support brings as
    opposed to just letting Sledgehammer do what it would normally do
...
So we can show the success rates, in a table like this:
                 ...
                 Datatype suite     Mixed suite        Codatatype suite
                (2345 problems)    (XXX problems)       (1240 problems)

   w/o (co)data        800           1255                699
   w data              815           1268                
   w codata                          1270                712
   w both                            1273
\end{verbatim}}
