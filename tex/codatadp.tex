...
that associates a potentially cyclic $\mu$-term as representative with each equivalence class.
...
The variable $x$ need not occur under the binder's body, in which case the
...
\]
We write $\FV( \Val )$ to denote the \relax{free variables} occurring in $\Val$, which
exclude variables that occur beneath $\mu$-binders.
