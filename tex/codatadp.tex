...
while the rules \rn{Decomp} and \rn{Clash} together compute (downward) unification.
...
whose root node is $\Ec \cup t_1 \teq t_2$ obtained by applying one of the rules \rn{Refl}, \rn{Symm}, \rn{Trans}, \rn{Cong}, \rn{Decomp}, \rn{Bisimilar}, or \rn{Singleton}.
...
By our construction and since \rn{Decomp} and \rn{Clash} do not apply to $\Fc$, 
