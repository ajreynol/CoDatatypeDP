...
\begin{table}[t!]
\begin{center}\begin{tabular}{@{}l@{\kern1em}c@{\kern.5em}c@{\kern.5em}c@{\kern1em}c@{}}
  & \HD{Distro} & \HD{\emph{AFP}} & \HD{\landg} & \HD{All}
...
Total number of goals
  & 1011\phantom{0} & 1121\phantom{0} & 899 & 3001\phantom{0}
\end{tabular}\end{center}
\caption{Number of solved goals for three benchmark suites}
\end{table}

Do we lose any problems by enabling it?

{\footnotesize
\begin{verbatim}
So we can show the success rates, in a table like this:

                 Codatatype suite     Mixed suite        Datatype suite
                (2345 problems)    (XXX problems)       (1240 problems)

   w/o (co)data        800           922                699
   w codata            815 (2)       939 (3)
   w data                            953 (6)            712 (4)
   w both                            970 (3+6)
\end{verbatim}}
