...
whereas $\tau,\:\upsilon$ range over arbitrary types. When applied to terms,
...
Nonetheless, it is convenient to make an exception for natural number
...
\newcommand\elll{\kern.2ex l\kern.14ex}
...
\!(\keyw{co})\keyw{datatype}\;\,
  \delta_1 & {}= \smash{\const{C}_{11\!}(\bigl[\const{s}_{11\!}^1{:}\bigr]\vthinspace \tau_{11\!}^1, \ldots, \bigl[\const{s}_{11\!}^{n_{11\!}}{:}\bigr]\vthinspace \tau_{11\!}^{n_{11\!}})} \mid \cdots \mid \smash{\const{C}_{1m}(\bigl[\const{s}_{1m}^1{:}\bigr]\vthinspace \tau_{1m}^1, \ldots, \bigl[\const{s}_{1m}^{n_{1m}}{:}\bigr]\vthinspace \tau_{1m}^{n_{1m}})} \\
   \smash{\vdots\,\,\,} \\[-1\jot]
  \keyw{and}\; \,\delta_l & = \smash{\const{C}_{\elll 1\!}(\bigl[\const{s}_{\elll 1\!}^1{:}\bigr]\vthinspace \tau_{\elll 1\!}^1, \ldots, \bigl[\const{s}_{\elll 1\!}^{n_{\elll 1\!}}{:}\bigr]\vthinspace \tau_{\elll 1\!}^{n_{\elll 1\!}})} \mid \cdots \mid \smash{\const{C}_{\elll m}(\bigl[\const{s}_{\elll m}^1{:}\bigr]\vthinspace \tau_{\elll m}^1, \ldots, \bigl[\const{s}_{\elll m}^{n_{\elll m}}{:}\bigr]\vthinspace \tau_{\elll m}^{n_{\elll m}})}
\end{aligned}
\]
%
with
