...
applying \const{f} to $n$ well-typed arguments $t_1 : \tau_1$, \ldots, $t_n :
\tau_n$. Nullary function symbols are called constants and can appear as is in
terms, without parentheses.
...
When applying the rules in Figure~\ref{fig:ab-rules}, 
