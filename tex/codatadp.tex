...
bisimilarity axiom schema, which asserts that two values having the same
corecursive specification---e.g., $x \teq \const{C}(x)$ and $y \teq
\const{C}(y)$---must be identical.
