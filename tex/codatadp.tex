...
datatypes and codatatypes. The dual of the acyclicity rule of datatypes is a
bisimilarity rule that identifies observationally equal values. The procedure is
compatible with the Nelson--Oppen combination method and is useful for both
proving and model finding. It has been implemented in the latest version of
CVC4, a modern SMT solver. An evaluation based on problems generated from
Isabelle/HOL theories demonstrates the potential of the procedure in a proving
context.
\end{abstract}
...
(\keyw{co})\keyw{datatype}\;\,
  \delta_1 & {}=\, \const{C}_{11}(\bigl[\const{s}_{111}{:}\bigr]\; \sigma_{111}, \,\ldots,\, \bigl[\const{s}_{11n_{11}}{:}\bigr]\; \sigma_{11n_{11}}) & \\
           & {}\;\phantom{=\,}\;{} \smash{\,\,\vdots} \\ % {}\;\phantom{=}\llap{\ensuremath{\mid}}\; \cdots \\
...
% (although it makes sense and is supported by Isabelle \cite{xxx}).
