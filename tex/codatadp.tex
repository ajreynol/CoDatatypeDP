...
included the theory files from the Isabelle distribution and the \emph{Archive
...
Andreas Lochbihler and Peter Gammie. We complemented the benchark suite with
some theories about various list and tree data structures, to also test the
datatypes. The theory files were selected before running the experiments.
