...
by the induction hypothesis $\Ec \mathrel\cup t \teq \const C_{\negvthinspace j}( \const s^1_{\negvthinspace j}( t ), \ldots, \const s^{\,\smash{n_{\negvthinspace j}}}_{\negvthinspace j}( t ) )$ is unsatisfiable
for each $\const C_{\negvthinspace j} \in \Ctr^\delta$.
