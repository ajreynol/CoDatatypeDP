...
it contains no free variables. \hfill It is \emph{cyclic} if %and only if --- ditto
it contains a bound variable. \hfill The
\goodbreak %%% TYPESETTING: horrible hacks (including two hfills)
\noindent
