...
Modulo $\alpha$-equivalence, the set \smash{$\Terms^{\smash{\J}}_{{\Varec{z}}}( \Val )$} is
$%\begin{array}{c}
\{
\MU z.\; \const{D}( z ),\;
...
On the other hand, if the value assigned to ${\Varec{z}}$ is fresh, %not $\alpha$-equivalent to any term in $\Terms^{\smash{\M}}_{{\Varec{z}}}( \Val )$,
