...
\cite{barrett-et-al-2010} format, implemented by most SMT %(satisfiability
%modulo theories)
...
% TODO: Leon, RADA -- http://www-users.cs.umn.edu/~hung/papers/fse13.pdf
...
would apply \rn{Split} and \rn{Inject} before adding this equality\end{rep}. 
