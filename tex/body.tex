...
takes as input a combination
%%% TODO, @ANDY: "a combination" -> "the union"?
...
types not belonging to $T_i$. Let us call this set $M_i$.
%%% TODO, @ANDY: which set M_i?
Each $T_i$ solver
...
in practice we often want to solve problems that combine reasoning about universal axioms and existential conjectures,
...
impact the correctness of our procedure in this setting,
since %by assumption
...
We have found that this leads to better performance because the alternative introduces terms more eagerly to $\tEc$.
