...
success rate increase of over \OK{5\%}, which is quite significant. The
practical usefulness of interpreted (co)datatypes appears roughly comparable to
that of arithmetic \cite{blanchette-et-al-2013-smt}.
The raw data also reveals that the
stronger decision procedures almost completely subsume the weaker ones. 
