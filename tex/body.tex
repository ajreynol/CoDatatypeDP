...
because they are restricted to an $\omega$-regular values, whereas models must
also cater for acyclic infinite terms. However, by monotonicity of ground
constraints, it is trivial to extend a normal interpretation into a model.
In the following, we focus on normal interpretations.
