...
$\interp{\J}{f}$ denotes the interpretation of a function $f$ in $\J$.
If $f$ is of type $ \tau_1 \times \cdots \times \tau_n \to \tau$,
then $\interp{\J}{f}$ is a total function of type $ \interp{\J}{\tau_1} \times \cdots \times \interp{\J}{\tau_n} \to \interp{\J}{\tau}$.
...
\item
For each type $\tau$,
$\interp{\J}{\tau}$ contains a maximal set of closed normal $\mu$-terms of that type that are
...
Thus $\expand{t_u}{u_\iPrime} \vsim \expand{\ValC \ec{t}}{ w_i }$. % for each $i \in [n]$.
...
Due to the induction hypothesis and Lemma~\ref{lem:interpretation-completion}\PART{3}, $\interp{\J}{u} \neq \interp{\J}{u'}$ for all such $u$, $u'$.
...
Since $\interp{\J}{t_1} \vsim \ValC \ec{t_1}$ and $\interp{\J}{t_2} \vsim \ValC \ec{t_2}$,
by Lemma~\ref{lem:interpretation-completion}\PART{3}, $\interp{\J}{t_1} \neq \interp{\J}{t_2}$, and thus $\J \models t_1 \tneq t_2$.
