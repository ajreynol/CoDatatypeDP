...
properties mentioned in this section. In particular, each interpretation
in~$\mathbf{I}$ has a fixed interpretation for constructor terms and correctly
applied selector terms, but may differ on its interpretation for wrongly applied
selector terms and variables. A formula $\varphi$ is $\thD$-\emph{satisfiable} if there
