...
constructors' argument types. This step relies on the assumption that
ordinary types are infinite.
...
These methods extend naturally to quantified formulas involving datatypes and codatatypes.
...
recent addition to Isabelle \cite{blanchette-et-al-2014-impl}. We
