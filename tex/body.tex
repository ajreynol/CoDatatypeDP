...
The calculus is implemented as a \relax{theory solver} of CVC4, that is, a
...
the value $\bot$. Then, %at a high level,
by a variant
...
Assume $\Ec$ is initially the set $M_i$ described above. With each equality $t \teq s$ added
