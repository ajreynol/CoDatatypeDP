...
quantified and range over all $i$, $j$, $\jPrime$, and $k$ within bounds:\rem{Introduce that $\is{C}$ is notation for discriminators.}
...
constructors' argument types (assuming all types in $\Nondata$ are
infinite).
