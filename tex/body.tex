...
Assigning a value for $\Val \ec{x}$ that is $\alpha$-equivalent to a value in $\mathcalx{T}^{\smash{\J}}_{{\Varec{x}}}( \Val )$
...
On the other hand, if the value assigned to ${\Varec{x}}$ is fresh, %not $\alpha$-equivalent to any term in $\mathcalx{T}^{\smash{\M}}_{{\Varec{x}}}( \Val )$,
