...
since it may fail to recognize cases when the preconditions of \rn{Split} and \rn{Single} hold.
...
recent addition to Isabelle \cite{blanchette-et-al-2014-impl}. \rem{Necessary to mention this? Seems to detract from significance of contribution.} We
