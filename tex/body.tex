...
\begin{table*}[tbh!]
\normalsize
\begin{center}\begin{tabular}{@{\;}l@{\kern1.5em}c@{\kern.5em}c@{\kern.5em}c@{\kern1.3em}c@{\;}}
  & \HD{Distro} & \HD{AFP} & \HD{\gandl} & \relax{All}
\MIDRULE
No (co)datatypes
  & 229 & 765 & \phantom{0}61 & 1055 \\[\jot]
%Datatype simplication only
%  &  \\
Datatypes without \rn{Acyclic}
  & 235 & 770 & \phantom{0}61 & 1066 \\
Full datatypes
  & 235 & 773 & \phantom{0}61 & 1069 \\[\jot]
