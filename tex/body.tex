...
rules are essential to exclude spurious models. Finally, it might be
...
%
Andreas Lochbihler, Mark Summerfield, and Dmitriy Traytel suggested several
textual improvements. The second author's research was partially supported by
the Deutsche Forschungs\-gemein\-schaft (DFG) project \relax{Hardening the
Hammer} (grant Ni\,491\slash 14-1).
