...
same type\end{rep}; (2)~additional (dis)equalities between variables of
...
\kern-0.7pt %% TYPESETTING: hack

\section{Evaluation on Isabelle Problems}
\label{sec:experimental-results}

\kern-0.3pt %% TYPESETTING: hack
...
that define codatatypes falling within the supported fragment. \hfill We added
two

\pagebreak %%% TYPESETTING: hack (including \hfill)

\noindent
unpublished theories by Peter Gammie and Andreas Lochbihler (\gandl, 317
