...
(model soundness) on ground problems. %and the absence of spurious models.
...
Since the literals in $\Ec$ are ground, they cannot entail an upper
...
While the decision procedure is restricted to ground literals,
...
presented in Section~\ref{sec:the-ground-decision-procedure} is \relax{incomplete}
