...
derivation rule to the parent node. \hfill A
derivation tree
\goodbreak\noindent %%% TYPESETTING: horrible HACKS
is \emph{closed} if all of
...
various terms in $\tEc$, the set of $\Sig$-terms occurring in $\Ec$.
