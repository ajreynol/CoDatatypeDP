...
Given a theory $T = T_1 \mathrel\cup \cdots \mathrel\cup T_n$ and a input set of
...
$\thD$-unsatisfiable. For the \rn{Split} rule, we add a clause of the form
$\const{C}_1\bigl( \const s^1_1( t ), \ldots, \const s^{n_1}_1( t ) \bigr)
