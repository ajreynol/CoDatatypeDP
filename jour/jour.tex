...
Continuing with Example~\ref{ex:assign}, while extending $\Val$ to its corresponding completion $\ValC$,
...
We may construct an interpretation $\J$ where variables are assigned the value
