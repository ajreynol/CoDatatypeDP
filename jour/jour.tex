...
such that equivalence classes having a constructor term with top symbol $\const{C}$ are placed in the same subset, for each constructor $\const{C}$.
...
development version of CVC4 (\textbf{TODO: which revision?}) and to
Z3 4.3.2 (\textbf{TODO: really?}) for comparison, each running for
