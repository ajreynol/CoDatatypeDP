...
\newcommand\HD[1]{\hbox to2em{\footnotesize\hfill\!\!\!\!#1\!\!\!\!\hfill}}
  ...
  * decision procedure useful both for proving and for model finding
  * model finding: critical, without it unsound models
  * contribution to proving is less clear
    * some parts can be axiomatized
    * only acyclicity and uniqueness, but how often do they pop up in practice?
...
added unpublished theories about Bird and Stern--Brocot trees
...
For each goal in each theory, we used Sledgehammer to select either 16 or
...
development version of CVC4 (\textbf{which revision?}) and to
Z3 4.3.2 (\textbf{really?}) for comparison, each running for
...
reasoning. This is especially the case for problems generated using 256~lemmas.
The problems with 16~lemmas put more stress on the decision procedure but are
less typical of Sledgehammer.
